...
import { customerEmail, adminEmail, adminEmailError } from "../nodemailer/templates.js";
...
async function addCustomer(req, res) {
  try {
    ...
    sendMail({
      from: `"Felix Cykelmeck" <${process.env.EMAIL_USER}>`,
      to: process.env.EMAIL_USER,
      subject: "Ny inlämnad cykel - fel",
      html: adminEmailError(req.body),
    })
  }
}
...
async function updateCustomer(req, res) {
  try {
    ...
    const updatedCustomer = await CustomerModel.findByIdAndUpdate(req.params.id, { parts: body.parts, partPrices: body.partPrices, priceAccepted: body.priceAccepted, priceSent: body.priceSent, bikeDone: body.bikeDone, mechanicComments: body.mechanicComments, customerConnection: body.customerConnection, email: body.customerInfo.email, phone: body.customerInfo.phone }, { new: true });
